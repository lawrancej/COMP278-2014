...
The function table for a 4-1 multiplexer (4 input, 1 output MUX) is as follows:
...
Select bits S1 and S0 represent S in binary. 

== Truth/function table to multiplexer

To implement a combination logic function with a multiplexer, the number of rows in the truth/function table must equal the number of inputs to the multiplexer.
